const { exportAnnotations } = require('../download')

const item = require('./seeds/item.json')
const annotations = require('./seeds/annotations.json')

describe('Export', () => {
  test('Classification + Ner with relation Export', () => {
    const output = exportAnnotations(item, annotations)
